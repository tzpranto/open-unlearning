...
class BLUR_NPO(BIUnlearnTrainer):
    """BLUR with NPO (Negative Preference Optimization) for unlearning."""

    def __init__(self, beta=1.0, retain_loss_type="NLL", *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.beta = beta
        self.retain_loss_type = retain_loss_type
        self.ref_model = None
