#!/bin/bash
# MUSE Books baselines: 7 methods, paper-correct configs, per-method max bs (eff_bs=32)
# NOTE: bs values from Llama-2-7b search — same model used for Books
set -euo pipefail
...
PROGRESS="/tmp/muse_books_progress.log"
...
# ─── 5. BLURNPO (bs=1, accum=32, eff=32) ────────────────────────────────────
...
# ─── 6. RMU (bs=4, accum=8, eff=32, max_steps=80) ───────────────────────────
...
# ─── 7. DS-BiAL (bs=1, accum=32, eff=32) ────────────────────────────────────
