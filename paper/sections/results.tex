...
\centering
\small
\caption{MUSE News (5-fold; $^\dagger$seed=42, BLURNPO OOM). Best HM in \textbf{bold}.}
\label{tab:muse_news}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{@{}lcccc@{}}
\toprule
