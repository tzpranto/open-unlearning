...
\centering
\small
\caption{KnowUndo Copyright (5-fold; $^\dagger$seed=42). HM = hmean(1$-$fgt\_R, ret\_R, MMLU). Judge HM = hmean(1$-$FL/2, RA/2, rRQ/2). Opus~4.6 used as judge since Opus~4.7 safety guardrails refuse to evaluate copyrighted content. Best in \textbf{bold}.}
...
BLURNPO$^\dagger$ & .494 & .023 & .689 & .140 & .287 & --- & --- & --- & --- \\
\midrule
...
\centering
\small
\caption{KnowUndo Privacy (5-fold; $^\dagger$seed=42). HM = hmean(1$-$fgt\_R, ret\_R, MMLU). Judge HM = hmean(1$-$FL/2, RA/2, rRQ/2). Best in \textbf{bold}.}
...
BLURNPO$^\dagger$ & .103 & .038 & .704 & .362 & .498 & --- & --- & --- & --- \\
\midrule
